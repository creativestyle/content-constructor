...
namespace Creativestyle\ContentConstructor\Components\Picker;

class PickerAdmin extends \Creativestyle\ContentConstructor\AbstractAdminComponent
{
    ...
    private $locator;
    /**
     * @var \Creativestyle\ContentConstructor\ComponentSupport
     */
    ...
    public function __construct(
        ...
        \Creativestyle\ContentConstructor\ComponentSupport $componentSupport
    )
    {
